(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const c of s)if(c.type==="childList")for(const h of c.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&r(h)}).observe(document,{childList:!0,subtree:!0});function i(s){const c={};return s.integrity&&(c.integrity=s.integrity),s.referrerPolicy&&(c.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?c.credentials="include":s.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function r(s){if(s.ep)return;s.ep=!0;const c=i(s);fetch(s.href,c)}})();function fl(l,e,i,r){if(typeof e=="function"?l!==e||!r:!e.has(l))throw new TypeError("Cannot read private member from an object whose class did not declare it");return i==="m"?r:i==="a"?r.call(l):r?r.value:e.get(l)}function pl(l,e,i,r,s){if(typeof e=="function"?l!==e||!0:!e.has(l))throw new TypeError("Cannot write private member to an object whose class did not declare it");return e.set(l,i),i}var C;const x="__TAURI_TO_IPC_KEY__";function wl(l,e=!1){return window.__TAURI_INTERNALS__.transformCallback(l,e)}async function t(l,e={},i){return window.__TAURI_INTERNALS__.invoke(l,e,i)}class xl{get rid(){return fl(this,C,"f")}constructor(e){C.set(this,void 0),pl(this,C,e)}async close(){return t("plugin:resources|close",{rid:this.rid})}}C=new WeakMap;class tl{constructor(...e){this.type="Logical",e.length===1?"Logical"in e[0]?(this.width=e[0].Logical.width,this.height=e[0].Logical.height):(this.width=e[0].width,this.height=e[0].height):(this.width=e[0],this.height=e[1])}toPhysical(e){return new E(this.width*e,this.height*e)}[x](){return{width:this.width,height:this.height}}toJSON(){return this[x]()}}class E{constructor(...e){this.type="Physical",e.length===1?"Physical"in e[0]?(this.width=e[0].Physical.width,this.height=e[0].Physical.height):(this.width=e[0].width,this.height=e[0].height):(this.width=e[0],this.height=e[1])}toLogical(e){return new tl(this.width/e,this.height/e)}[x](){return{width:this.width,height:this.height}}toJSON(){return this[x]()}}class v{constructor(e){this.size=e}toLogical(e){return this.size instanceof tl?this.size:this.size.toLogical(e)}toPhysical(e){return this.size instanceof E?this.size:this.size.toPhysical(e)}[x](){return{[`${this.size.type}`]:{width:this.size.width,height:this.size.height}}}toJSON(){return this[x]()}}class rl{constructor(...e){this.type="Logical",e.length===1?"Logical"in e[0]?(this.x=e[0].Logical.x,this.y=e[0].Logical.y):(this.x=e[0].x,this.y=e[0].y):(this.x=e[0],this.y=e[1])}toPhysical(e){return new F(this.x*e,this.y*e)}[x](){return{x:this.x,y:this.y}}toJSON(){return this[x]()}}class F{constructor(...e){this.type="Physical",e.length===1?"Physical"in e[0]?(this.x=e[0].Physical.x,this.y=e[0].Physical.y):(this.x=e[0].x,this.y=e[0].y):(this.x=e[0],this.y=e[1])}toLogical(e){return new rl(this.x/e,this.y/e)}[x](){return{x:this.x,y:this.y}}toJSON(){return this[x]()}}class A{constructor(e){this.position=e}toLogical(e){return this.position instanceof rl?this.position:this.position.toLogical(e)}toPhysical(e){return this.position instanceof F?this.position:this.position.toPhysical(e)}[x](){return{[`${this.position.type}`]:{x:this.position.x,y:this.position.y}}}toJSON(){return this[x]()}}var f;(function(l){l.WINDOW_RESIZED="tauri://resize",l.WINDOW_MOVED="tauri://move",l.WINDOW_CLOSE_REQUESTED="tauri://close-requested",l.WINDOW_DESTROYED="tauri://destroyed",l.WINDOW_FOCUS="tauri://focus",l.WINDOW_BLUR="tauri://blur",l.WINDOW_SCALE_FACTOR_CHANGED="tauri://scale-change",l.WINDOW_THEME_CHANGED="tauri://theme-changed",l.WINDOW_CREATED="tauri://window-created",l.WEBVIEW_CREATED="tauri://webview-created",l.DRAG_ENTER="tauri://drag-enter",l.DRAG_OVER="tauri://drag-over",l.DRAG_DROP="tauri://drag-drop",l.DRAG_LEAVE="tauri://drag-leave"})(f||(f={}));async function sl(l,e){window.__TAURI_EVENT_PLUGIN_INTERNALS__.unregisterListener(l,e),await t("plugin:event|unlisten",{event:l,eventId:e})}async function cl(l,e,i){var r;const s=typeof(i==null?void 0:i.target)=="string"?{kind:"AnyLabel",label:i.target}:(r=i==null?void 0:i.target)!==null&&r!==void 0?r:{kind:"Any"};return t("plugin:event|listen",{event:l,target:s,handler:wl(e)}).then(c=>async()=>sl(l,c))}async function gl(l,e,i){return cl(l,r=>{sl(l,r.id),e(r)},i)}async function ul(l,e){await t("plugin:event|emit",{event:l,payload:e})}async function Fl(l,e,i){await t("plugin:event|emit_to",{target:typeof l=="string"?{kind:"AnyLabel",label:l}:l,event:e,payload:i})}class Q extends xl{constructor(e){super(e)}static async new(e,i,r){return t("plugin:image|new",{rgba:M(e),width:i,height:r}).then(s=>new Q(s))}static async fromBytes(e){return t("plugin:image|from_bytes",{bytes:M(e)}).then(i=>new Q(i))}static async fromPath(e){return t("plugin:image|from_path",{path:e}).then(i=>new Q(i))}async rgba(){return t("plugin:image|rgba",{rid:this.rid}).then(e=>new Uint8Array(e))}async size(){return t("plugin:image|size",{rid:this.rid})}}function M(l){return l==null?null:typeof l=="string"?l:l instanceof Q?l.rid:l}var N;(function(l){l[l.Critical=1]="Critical",l[l.Informational=2]="Informational"})(N||(N={}));class kl{constructor(e){this._preventDefault=!1,this.event=e.event,this.id=e.id}preventDefault(){this._preventDefault=!0}isPreventDefault(){return this._preventDefault}}var U;(function(l){l.None="none",l.Normal="normal",l.Indeterminate="indeterminate",l.Paused="paused",l.Error="error"})(U||(U={}));function nl(){return new al(window.__TAURI_INTERNALS__.metadata.currentWindow.label,{skip:!0})}async function I(){return t("plugin:window|get_all_windows").then(l=>l.map(e=>new al(e,{skip:!0})))}const Z=["tauri://created","tauri://error"];class al{constructor(e,i={}){var r;this.label=e,this.listeners=Object.create(null),i!=null&&i.skip||t("plugin:window|create",{options:{...i,parent:typeof i.parent=="string"?i.parent:(r=i.parent)===null||r===void 0?void 0:r.label,label:e}}).then(async()=>this.emit("tauri://created")).catch(async s=>this.emit("tauri://error",s))}static async getByLabel(e){var i;return(i=(await I()).find(r=>r.label===e))!==null&&i!==void 0?i:null}static getCurrent(){return nl()}static async getAll(){return I()}static async getFocusedWindow(){for(const e of await I())if(await e.isFocused())return e;return null}async listen(e,i){return this._handleTauriEvent(e,i)?()=>{const r=this.listeners[e];r.splice(r.indexOf(i),1)}:cl(e,i,{target:{kind:"Window",label:this.label}})}async once(e,i){return this._handleTauriEvent(e,i)?()=>{const r=this.listeners[e];r.splice(r.indexOf(i),1)}:gl(e,i,{target:{kind:"Window",label:this.label}})}async emit(e,i){if(Z.includes(e)){for(const r of this.listeners[e]||[])r({event:e,id:-1,payload:i});return}return ul(e,i)}async emitTo(e,i,r){if(Z.includes(i)){for(const s of this.listeners[i]||[])s({event:i,id:-1,payload:r});return}return Fl(e,i,r)}_handleTauriEvent(e,i){return Z.includes(e)?(e in this.listeners?this.listeners[e].push(i):this.listeners[e]=[i],!0):!1}async scaleFactor(){return t("plugin:window|scale_factor",{label:this.label})}async innerPosition(){return t("plugin:window|inner_position",{label:this.label}).then(e=>new F(e))}async outerPosition(){return t("plugin:window|outer_position",{label:this.label}).then(e=>new F(e))}async innerSize(){return t("plugin:window|inner_size",{label:this.label}).then(e=>new E(e))}async outerSize(){return t("plugin:window|outer_size",{label:this.label}).then(e=>new E(e))}async isFullscreen(){return t("plugin:window|is_fullscreen",{label:this.label})}async isMinimized(){return t("plugin:window|is_minimized",{label:this.label})}async isMaximized(){return t("plugin:window|is_maximized",{label:this.label})}async isFocused(){return t("plugin:window|is_focused",{label:this.label})}async isDecorated(){return t("plugin:window|is_decorated",{label:this.label})}async isResizable(){return t("plugin:window|is_resizable",{label:this.label})}async isMaximizable(){return t("plugin:window|is_maximizable",{label:this.label})}async isMinimizable(){return t("plugin:window|is_minimizable",{label:this.label})}async isClosable(){return t("plugin:window|is_closable",{label:this.label})}async isVisible(){return t("plugin:window|is_visible",{label:this.label})}async title(){return t("plugin:window|title",{label:this.label})}async theme(){return t("plugin:window|theme",{label:this.label})}async isAlwaysOnTop(){return t("plugin:window|is_always_on_top",{label:this.label})}async center(){return t("plugin:window|center",{label:this.label})}async requestUserAttention(e){let i=null;return e&&(e===N.Critical?i={type:"Critical"}:i={type:"Informational"}),t("plugin:window|request_user_attention",{label:this.label,value:i})}async setResizable(e){return t("plugin:window|set_resizable",{label:this.label,value:e})}async setEnabled(e){return t("plugin:window|set_enabled",{label:this.label,value:e})}async isEnabled(){return t("plugin:window|is_enabled",{label:this.label})}async setMaximizable(e){return t("plugin:window|set_maximizable",{label:this.label,value:e})}async setMinimizable(e){return t("plugin:window|set_minimizable",{label:this.label,value:e})}async setClosable(e){return t("plugin:window|set_closable",{label:this.label,value:e})}async setTitle(e){return t("plugin:window|set_title",{label:this.label,value:e})}async maximize(){return t("plugin:window|maximize",{label:this.label})}async unmaximize(){return t("plugin:window|unmaximize",{label:this.label})}async toggleMaximize(){return t("plugin:window|toggle_maximize",{label:this.label})}async minimize(){return t("plugin:window|minimize",{label:this.label})}async unminimize(){return t("plugin:window|unminimize",{label:this.label})}async show(){return t("plugin:window|show",{label:this.label})}async hide(){return t("plugin:window|hide",{label:this.label})}async close(){return t("plugin:window|close",{label:this.label})}async destroy(){return t("plugin:window|destroy",{label:this.label})}async setDecorations(e){return t("plugin:window|set_decorations",{label:this.label,value:e})}async setShadow(e){return t("plugin:window|set_shadow",{label:this.label,value:e})}async setEffects(e){return t("plugin:window|set_effects",{label:this.label,value:e})}async clearEffects(){return t("plugin:window|set_effects",{label:this.label,value:null})}async setAlwaysOnTop(e){return t("plugin:window|set_always_on_top",{label:this.label,value:e})}async setAlwaysOnBottom(e){return t("plugin:window|set_always_on_bottom",{label:this.label,value:e})}async setContentProtected(e){return t("plugin:window|set_content_protected",{label:this.label,value:e})}async setSize(e){return t("plugin:window|set_size",{label:this.label,value:e instanceof v?e:new v(e)})}async setMinSize(e){return t("plugin:window|set_min_size",{label:this.label,value:e instanceof v?e:e?new v(e):null})}async setMaxSize(e){return t("plugin:window|set_max_size",{label:this.label,value:e instanceof v?e:e?new v(e):null})}async setSizeConstraints(e){function i(r){return r?{Logical:r}:null}return t("plugin:window|set_size_constraints",{label:this.label,value:{minWidth:i(e==null?void 0:e.minWidth),minHeight:i(e==null?void 0:e.minHeight),maxWidth:i(e==null?void 0:e.maxWidth),maxHeight:i(e==null?void 0:e.maxHeight)}})}async setPosition(e){return t("plugin:window|set_position",{label:this.label,value:e instanceof A?e:new A(e)})}async setFullscreen(e){return t("plugin:window|set_fullscreen",{label:this.label,value:e})}async setSimpleFullscreen(e){return t("plugin:window|set_simple_fullscreen",{label:this.label,value:e})}async setFocus(){return t("plugin:window|set_focus",{label:this.label})}async setFocusable(e){return t("plugin:window|set_focusable",{label:this.label,value:e})}async setIcon(e){return t("plugin:window|set_icon",{label:this.label,value:M(e)})}async setSkipTaskbar(e){return t("plugin:window|set_skip_taskbar",{label:this.label,value:e})}async setCursorGrab(e){return t("plugin:window|set_cursor_grab",{label:this.label,value:e})}async setCursorVisible(e){return t("plugin:window|set_cursor_visible",{label:this.label,value:e})}async setCursorIcon(e){return t("plugin:window|set_cursor_icon",{label:this.label,value:e})}async setBackgroundColor(e){return t("plugin:window|set_background_color",{color:e})}async setCursorPosition(e){return t("plugin:window|set_cursor_position",{label:this.label,value:e instanceof A?e:new A(e)})}async setIgnoreCursorEvents(e){return t("plugin:window|set_ignore_cursor_events",{label:this.label,value:e})}async startDragging(){return t("plugin:window|start_dragging",{label:this.label})}async startResizeDragging(e){return t("plugin:window|start_resize_dragging",{label:this.label,value:e})}async setBadgeCount(e){return t("plugin:window|set_badge_count",{label:this.label,value:e})}async setBadgeLabel(e){return t("plugin:window|set_badge_label",{label:this.label,value:e})}async setOverlayIcon(e){return t("plugin:window|set_overlay_icon",{label:this.label,value:e?M(e):void 0})}async setProgressBar(e){return t("plugin:window|set_progress_bar",{label:this.label,value:e})}async setVisibleOnAllWorkspaces(e){return t("plugin:window|set_visible_on_all_workspaces",{label:this.label,value:e})}async setTitleBarStyle(e){return t("plugin:window|set_title_bar_style",{label:this.label,value:e})}async setTheme(e){return t("plugin:window|set_theme",{label:this.label,value:e})}async onResized(e){return this.listen(f.WINDOW_RESIZED,i=>{i.payload=new E(i.payload),e(i)})}async onMoved(e){return this.listen(f.WINDOW_MOVED,i=>{i.payload=new F(i.payload),e(i)})}async onCloseRequested(e){return this.listen(f.WINDOW_CLOSE_REQUESTED,async i=>{const r=new kl(i);await e(r),r.isPreventDefault()||await this.destroy()})}async onDragDropEvent(e){const i=await this.listen(f.DRAG_ENTER,h=>{e({...h,payload:{type:"enter",paths:h.payload.paths,position:new F(h.payload.position)}})}),r=await this.listen(f.DRAG_OVER,h=>{e({...h,payload:{type:"over",position:new F(h.payload.position)}})}),s=await this.listen(f.DRAG_DROP,h=>{e({...h,payload:{type:"drop",paths:h.payload.paths,position:new F(h.payload.position)}})}),c=await this.listen(f.DRAG_LEAVE,h=>{e({...h,payload:{type:"leave"}})});return()=>{i(),s(),r(),c()}}async onFocusChanged(e){const i=await this.listen(f.WINDOW_FOCUS,s=>{e({...s,payload:!0})}),r=await this.listen(f.WINDOW_BLUR,s=>{e({...s,payload:!1})});return()=>{i(),r()}}async onScaleChanged(e){return this.listen(f.WINDOW_SCALE_FACTOR_CHANGED,e)}async onThemeChanged(e){return this.listen(f.WINDOW_THEME_CHANGED,e)}}var V;(function(l){l.Disabled="disabled",l.Throttle="throttle",l.Suspend="suspend"})(V||(V={}));var q;(function(l){l.Default="default",l.FluentOverlay="fluentOverlay"})(q||(q={}));var j;(function(l){l.AppearanceBased="appearanceBased",l.Light="light",l.Dark="dark",l.MediumLight="mediumLight",l.UltraDark="ultraDark",l.Titlebar="titlebar",l.Selection="selection",l.Menu="menu",l.Popover="popover",l.Sidebar="sidebar",l.HeaderView="headerView",l.Sheet="sheet",l.WindowBackground="windowBackground",l.HudWindow="hudWindow",l.FullScreenUI="fullScreenUI",l.Tooltip="tooltip",l.ContentBackground="contentBackground",l.UnderWindowBackground="underWindowBackground",l.UnderPageBackground="underPageBackground",l.Mica="mica",l.Blur="blur",l.Acrylic="acrylic",l.Tabbed="tabbed",l.TabbedDark="tabbedDark",l.TabbedLight="tabbedLight"})(j||(j={}));var J;(function(l){l.FollowsWindowActiveState="followsWindowActiveState",l.Active="active",l.Inactive="inactive"})(J||(J={}));const n=`<defs>
  ...
  <filter id="f-shadow" x="-20%" y="-20%" width="140%" height="140%">
    ...
    <ellipse cx="${i}" cy="${r}" rx="${c}" ry="3.5" fill="rgba(255,120,120,${s})"/>`}const ol={id:"sakura",name:"小樱",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
  ...
  </svg>`,css:""},ml={id:"xiaolan",name:"小蓝",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
    <!-- 头 -->
  ...
  </svg>`,css:""},vl={id:"neko",name:"猫咪",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
    <!-- 猫耳 -->
  ...
  </svg>`,css:""},$l={id:"bunny",name:"兔兔",svg:l=>`<svg viewBox="0 0 100 130" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
    <!-- 长耳朵 -->
  ...
  </svg>`,css:""},bl={id:"bear",name:"小熊",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
    <!-- 圆耳 -->
  ...
  </svg>`,css:""},El={id:"elf",name:"精灵",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    <defs>
  ...
  </svg>`,css:""},Ql={id:"fox",name:"小狐",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Dl={id:"penguin",name:"企鹅",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Al={id:"shiba",name:"柴犬",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},_l={id:"panda",name:"熊猫",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Cl={id:"unicorn",name:"独角兽",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Ll={id:"robot",name:"机器人",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Ml={id:"ghost",name:"幽灵",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Il={id:"chick",name:"小鸡",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Zl={id:"slime",name:"史莱姆",svg:l=>`<svg viewBox="0 0 100 110" xmlns="http://www.w3.org/2000/svg">${n}
  ...
  </svg>`,css:""},zl={id:"demon",name:"小恶魔",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Sl={id:"angel",name:"天使",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Ol={id:"ninja",name:"忍者",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Wl={id:"mermaid",name:"美人鱼",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
    <ellipse cx="50" cy="40" rx="27" ry="25" fill="#FFF0E0"/>
    <ellipse cx="50" cy="40" rx="27" ry="25" fill="url(#g-shine)"/>
  ...
  </svg>`,css:""},Nl={id:"pumpkin",name:"南瓜头",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Pl={id:"snowman",name:"雪人",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Tl={id:"sheep",name:"小羊",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Rl={id:"cactus",name:"仙人掌",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Gl={id:"mushroom",name:"蘑菇",svg:l=>`<svg viewBox="0 0 100 110" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Hl={id:"star",name:"星星",svg:l=>`<svg viewBox="0 0 100 110" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Ul={id:"octopus",name:"章鱼",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},Vl={id:"whale",name:"小鲸鱼",svg:l=>`<svg viewBox="0 0 100 110" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
  ...
  </svg>`,css:""},ql={id:"bat",name:"小蝙蝠",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},jl={id:"astronaut",name:"太空人",svg:l=>`<svg viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">${n}
    ${a(l)}
    <g filter="url(#f-shadow)">
  ...
  </svg>`,css:""},hl=[ol,ml,vl,$l,bl,El,Ql,Dl,Bl,Al,_l,Cl,Ll,Ml,Il,Zl,zl,Sl,Ol,Wl,Nl,Pl,Tl,Rl,Gl,Hl,Ul,Vl,ql,jl];function Jl(l){return hl.find(e=>e.id===l)||ol}const g=document.getElementById("pet");let p="idle",G="sakura",k=!1,L=null;const K=["idle","act-nod","act-shake","act-spin","act-jump","act-squat","act-lean-l","act-lean-r","act-peek-l","act-peek-r","act-stretch","act-dizzy","act-float","act-dance","act-wave","act-stomp","act-yawn","act-shiver","act-bounce2","act-roll","act-sway","act-tiptoe","act-slide-l","act-slide-r"];function dl(){yl(),L=window.setInterval(()=>{if(p!=="idle"||k)return;const l=K[Math.floor(Math.random()*K.length)];g.className=l,l!=="idle"&&setTimeout(()=>{!k&&p==="idle"&&(g.className="idle")},2500)},4e3)}function yl(){L!==null&&(clearInterval(L),L=null)}function Kl(l){G=l,H()}function w(l){p=l,H(),l==="idle"?dl():yl()}function H(){const l=Jl(G);g.innerHTML=l.svg(p),g.className=p}function Yl(l,e){if(k)return;k=!0;const i=p;w(l),setTimeout(()=>{p===l&&w(i==="hover"||i==="click"?"idle":i),k=!1},e)}function Xl(l){l&&(G=l),H(),dl(),g.addEventListener("mouseenter",()=>{p==="idle"&&!k&&w("hover")}),g.addEventListener("mouseleave",()=>{p==="hover"&&w("idle")}),g.addEventListener("click",e=>{e.stopPropagation(),!(p==="thinking"||p==="talking")&&Yl("click",700)}),g.addEventListener("dblclick",e=>{e.stopPropagation(),!(p==="thinking"||p==="talking")&&(k=!0,w("click"),setTimeout(()=>{w("idle"),setTimeout(()=>{w("click"),setTimeout(()=>{w("idle"),k=!1},500)},150)},500))}),g.addEventListener("mouseup",()=>{g.classList.add("dragged"),setTimeout(()=>g.classList.remove("dragged"),500)})}const D=document.getElementById("messages"),P=document.getElementById("chat-input"),le=document.getElementById("send-btn"),Y=document.getElementById("chat-area");document.getElementById("pet-area");const ee=document.getElementById("chat-close-btn");let b=[];async function ie(){try{b=await t("load_history"),b.forEach(l=>T(l.role,l.content))}catch{}document.getElementById("chat-btn").addEventListener("click",()=>{Y.classList.toggle("hidden")}),ee.addEventListener("click",()=>{Y.classList.add("hidden")}),le.addEventListener("click",X),P.addEventListener("keydown",l=>{l.key==="Enter"&&X()})}function T(l,e){const i=document.createElement("div");return i.className=`msg ${l}`,i.textContent=e,D.appendChild(i),D.scrollTop=D.scrollHeight,i}async function te(l,e){l.textContent="";for(let i=0;i<e.length;i++)l.textContent+=e[i],D.scrollTop=D.scrollHeight,await new Promise(r=>setTimeout(r,20))}async function X(){const l=P.value.trim();if(!l)return;P.value="",b.push({role:"user",content:l}),T("user",l),w("thinking");const e=T("assistant","思考中...");try{const i=await t("load_settings"),r=await t("get_api_key",{provider:i.provider});if(!r){e.textContent="请先在设置中配置 API Key~",w("idle");return}const s=await t("chat",{provider:i.provider,model:i.model,apiKey:r,systemPrompt:i.system_prompt,history:b});w("talking"),await te(e,s),b.push({role:"assistant",content:s}),await t("save_history",{messages:b})}catch(i){e.textContent=`出错了: ${i}`}w("idle")}const z=document.getElementById("settings-panel"),$=document.getElementById("provider-select"),R=document.getElementById("model-select"),_=document.getElementById("api-key-input"),ll=document.getElementById("system-prompt"),re=document.getElementById("save-settings-btn"),se=document.getElementById("close-settings-btn"),ce=document.getElementById("settings-btn"),m=document.getElementById("pet-size-input"),el=document.getElementById("pet-size-val"),il=document.getElementById("pet"),S=document.getElementById("character-grid");let B="sakura";const ne={deepseek:["deepseek-chat","deepseek-reasoner"],openai:["gpt-4o","gpt-4o-mini","o1-mini"],claude:["claude-sonnet-4-5-20250929","claude-haiku-4-5-20251001"]};function O(l){il.style.width=l+"px",il.style.height=l+"px"}function W(){const l=ne[$.value]||[];R.innerHTML=l.map(e=>`<option value="${e}">${e}</option>`).join("")}async function ae(){m.addEventListener("input",()=>{el.textContent=m.value,O(Number(m.value))}),$.addEventListener("change",async()=>{W(),_.value=await t("get_api_key",{provider:$.value})}),ce.addEventListener("click",async()=>{z.classList.remove("hidden");try{const l=await t("load_settings");$.value=l.provider,W(),R.value=l.model,ll.value=l.system_prompt,m.value=String(l.pet_size||100),el.textContent=m.value,B=l.character_id||"sakura",oe(),_.value=await t("get_api_key",{provider:l.provider})}catch{}}),se.addEventListener("click",()=>z.classList.add("hidden")),re.addEventListener("click",async()=>{try{await t("save_settings",{settings:{provider:$.value,model:R.value,system_prompt:ll.value,pet_size:Number(m.value),character_id:B}}),O(Number(m.value)),Kl(B),_.value&&await t("save_api_key",{provider:$.value,key:_.value}),z.classList.add("hidden")}catch(l){alert("保存失败: "+l)}}),W();try{const l=await t("load_settings");return l.pet_size&&O(l.pet_size),l.character_id||"sakura"}catch{}return"sakura"}function oe(){S.innerHTML=hl.map(l=>`
    <div class="char-option${l.id===B?" active":""}" data-id="${l.id}">
      ${l.svg("idle")}
      <span>${l.name}</span>
    </div>
  `).join(""),S.querySelectorAll(".char-option").forEach(l=>{l.addEventListener("click",()=>{B=l.dataset.id,S.querySelectorAll(".char-option").forEach(e=>e.classList.remove("active")),l.classList.add("active")})})}window.addEventListener("DOMContentLoaded",async()=>{ie();const l=await ae();Xl(l),document.getElementById("pet").addEventListener("mousedown",()=>{nl().startDragging()})});
